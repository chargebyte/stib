...
GPIOS=""
GPIOS="$GPIOS 83"  # MX6ULL_PAD_LCD_DATA14__GPIO3_IO19, DEBUG LED
GPIOS="$GPIOS 102"  # MX6ULL_PAD_NAND_DATA04__GPIO4_IO06, DEBUG LED
GPIOS="$GPIOS 103"  # MX6ULL_PAD_NAND_DATA05__GPIO4_IO07, DEBUG LED
...
GPIOS="$GPIOS 47"  # MX6ULL_PAD_ENET2_RX_ER__GPIO2_IO15, RELAY_1_SENSE CONTACTOR
...
GPIOS="$GPIOS 48"  # MX6ULL_PAD_SD1_CMD__GPIO2_IO16, RELAY_2_SENSE VENTILATION
